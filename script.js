const apiKey = "WRITE_YOUR_API_KEY";
const apodUrl = "https://api.nasa.gov/planetary/apod";
const afeedUrl = "https://api.nasa.gov/neo/rest/v1/feed";


function handleAFeedData({ near_earth_objects }, afeedElement, afeedTable) {
...
function contentLoaded() {
    ...
    fetch(`${apodUrl}?api_key=${apiKey}`).then(res => res.json()).then(data => {
